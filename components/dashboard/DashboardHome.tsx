    ...
    <>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={stat.label}
            className="bg-surface-container-lowest border border-border-muted rounded-lg p-5"
          >
              ...
              <div className="space-y-3">
                {recentActivity.map((a) => (
                  ...
                  >
                    ...
                    <ArrowUpRight
                      size={14}
                      className="text-on-surface-variant shrink-0 opacity-0 group-hover:opacity-100 transition-opacity"
                    />
                  </Link>
                ))}
              </div>
