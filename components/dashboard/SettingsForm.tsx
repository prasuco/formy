...
export function SettingsForm({
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-xl font-semibold text-on-surface tracking-tight">Settings</h1>
                <p className="text-sm text-on-surface-variant mt-1">Manage your account</p>
            </div>
            ...
            <div className="border border-destructive/20 rounded-lg overflow-hidden">
                ...
                <div className="px-6 py-4 space-y-4">
                    ...
                    <AlertDialog>
                        <AlertDialogTrigger render={<Button variant="destructive"><AlertTriangle size={14} />Delete Account</Button>} />
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>Delete your account?</AlertDialogTitle>
                                <AlertDialogDescription>
                                    This will permanently remove your account, forms, and all submissions.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
